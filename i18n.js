...
(function () {
  ...
  const I18N = {
    ...
    de: {
      ...
      "problem.bridge": "Diese Lücken schließen sich nicht von allein. Sie schließen sich, wenn Frauen befähigt werden, ihre Finanzen selbstbewusst in die Hand zu nehmen und in das zu investieren, was nachhaltig Veränderung schafft.",
      "problem.statement": 'Bei Portemonnaie haben wir es uns zur Aufgabe gemacht, gegen den 25% Pensionsgap in der EU, 29% weniger Investitionen pro Monat und eine 100.000€ Vermögenslücke im Lebenslauf zu <span class="underline-marigold">kämpfen</span>.',
      "mission.quote": '<span class="mission__word">Portemonnaie </span><span class="mission__word">existiert, </span><span class="mission__word">um </span><span class="mission__word">die </span><span class="mission__word">finanzielle </span><span class="mission__word">Geschlechterlücke </span><span class="mission__word">zu </span><span class="mission__word">schließen. </span><span class="mission__word">Denn </span><span class="mission__word">jedes </span><span class="mission__word">Investment </span><span class="mission__word">ist </span><span class="mission__word">eine </span><span class="mission__word">Stimme. </span><span class="mission__word">Wir </span><span class="mission__word">bauen </span><span class="mission__word">eine </span><span class="mission__word">Plattform, </span><span class="mission__word">die </span><span class="mission__word">es </span><span class="mission__word">dir </span><span class="mission__word">ermöglicht, </span><span class="mission__word">nach </span><span class="mission__word">deinen </span><span class="mission__word">Werten </span><span class="mission__word">zu </span><span class="mission__word">investieren, </span><span class="mission__word">das </span><span class="mission__word">Investieren </span><span class="mission__word">einfach </span><span class="mission__word">macht </span><span class="mission__word">und </span><span class="mission__word">von </span><span class="mission__word">Grund </span><span class="mission__word">auf </span><span class="mission__word">so </span><span class="mission__word">gestaltet </span><span class="mission__word">ist, </span><span class="mission__word">dass </span><span class="mission__word">alle </span><span class="mission__word">ihr </span><span class="mission__word">Geld </span><span class="mission__word">für </span><span class="mission__word">sich </span><span class="mission__word">sprechen </span><span class="mission__word">lassen </span><span class="mission__word">und </span><span class="mission__word">ihre </span><span class="mission__word">Zukunft </span><span class="mission__word">absichern </span><span class="mission__word">können.”</span>',
