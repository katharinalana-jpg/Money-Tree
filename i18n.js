...
(function () {
  ...
  const I18N = {
    en: {
      ...
      "problem.closing": "With our values. With our convictions. With what we decide. – For us and a better future.",
      "mission.quote": '<span class="mission__word">We\'re </span> <span class="mission__word">designing </span> <span class="mission__word"><span class="mission__mark">Portemonnaie Finance</span>, </span> <span class="mission__word">an </span> <span class="mission__word">investment </span> <span class="mission__word">guidance </span> <span class="mission__word">platform </span> <span class="mission__word">that </span> <span class="mission__word">takes </span> <span class="mission__word">you </span> <span class="mission__word">from </span> <span class="mission__word">your </span> <span class="mission__word">values </span> <span class="mission__word">to </span> <span class="mission__word">your </span> <span class="mission__word">first </span> <span class="mission__word">investment </span> <span class="mission__word">in </span> <span class="mission__word">under </span> <span class="mission__word">15 </span> <span class="mission__word">minutes.</span>',
      "mission.quote_sub": '<span class="mission__word">No </span> <span class="mission__word">finance </span> <span class="mission__word">bro </span> <span class="mission__word">attitude, </span> <span class="mission__word">no </span> <span class="mission__word">jargon, </span> <span class="mission__word">just </span> <span class="mission__word">women </span> <span class="mission__word">who </span> <span class="mission__word">believe </span> <span class="mission__word">that </span> <span class="mission__word">our </span> <span class="mission__word">financial </span> <span class="mission__word">decisions </span> <span class="mission__word">today </span> <span class="mission__word">shape </span> <span class="mission__word">the </span> <span class="mission__word">world </span> <span class="mission__word">of </span> <span class="mission__word">tomorrow.</span>',
    ...
    de: {
      ...
      "problem.closing": "Mit unseren Werten. Mit unseren Überzeugungen. Mit dem, was wir entscheiden. – Für uns und eine bessere Zukunft.",
      "mission.quote": '<span class="mission__word">Wir </span> <span class="mission__word">entwickeln </span> <span class="mission__word"><span class="mission__mark">Portemonnaie Finance</span>, </span> <span class="mission__word">eine </span> <span class="mission__word">Plattform </span> <span class="mission__word">für </span> <span class="mission__word">Investment </span> <span class="mission__word">Guidance, </span> <span class="mission__word">die </span> <span class="mission__word">dich </span> <span class="mission__word">in </span> <span class="mission__word">unter </span> <span class="mission__word">15 </span> <span class="mission__word">Minuten </span> <span class="mission__word">von </span> <span class="mission__word">deinen </span> <span class="mission__word">Werten </span> <span class="mission__word">zu </span> <span class="mission__word">deinem </span> <span class="mission__word">ersten </span> <span class="mission__word">Investment </span> <span class="mission__word">bringt.</span>',
      "mission.quote_sub": '<span class="mission__word">Keine </span> <span class="mission__word">Finance </span> <span class="mission__word">Bro </span> <span class="mission__word">Attitüde, </span> <span class="mission__word">kein </span> <span class="mission__word">Fachjargon, </span> <span class="mission__word">nur </span> <span class="mission__word">Frauen, </span> <span class="mission__word">die </span> <span class="mission__word">daran </span> <span class="mission__word">glauben, </span> <span class="mission__word">dass </span> <span class="mission__word">unsere </span> <span class="mission__word">finanziellen </span> <span class="mission__word">Entscheidungen </span> <span class="mission__word">von </span> <span class="mission__word">heute </span> <span class="mission__word">die </span> <span class="mission__word">Welt </span> <span class="mission__word">von </span> <span class="mission__word">morgen </span> <span class="mission__word">prägen.</span>',
