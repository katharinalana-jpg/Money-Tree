...
(function () {
  ...
  const I18N = {
    en: {
      ...
      "calc.h1": 'See how much you <span class="brush"><em class="serif">lose</em></span> by not investing.',
      "calc.sub": "Saving keeps your money safe, but it barely grows. Move the sliders to see how much you leave on the table by saving instead of investing the same amount each month.",
      ...
      "calc.result.label": "What you leave on the table by age",
    ...
    de: {
      ...
      "calc.h1": 'Sieh, was du jedes Jahr <span class="brush"><em class="serif">liegen lässt</em></span>.',
      "calc.sub": "Auf dem Sparkonto ist dein Geld sicher, aber es wächst kaum. Bewege die Regler und sieh, wie viel Geld du liegen lässt, wenn du den gleichen Betrag jeden Monat nur sparst, statt ihn zu investieren.",
      ...
      "calc.result.label": "Das lässt du liegen bis zum Alter von",
